---
name: safety-monitor
description: Crisis-response instruction for a host-selected current interaction. It pauses normal Noesis flows when the user expresses imminent harm, severe distress, or immediate danger; it is not a background monitor or lifecycle hook.
---
